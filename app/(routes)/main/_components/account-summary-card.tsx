...
export default function AccountSummaryCard({ account, savedTax }: Props) {
  if (!account) {
    return (
  ...
  return (
    <div className='bg-white rounded-2xl p-4 shadow-sm border border-gray-3'>
        ...
        <div className='flex items-start gap-2'>
          ...
          <div className='text-sm'>
            <div className='font-semibold text-gray-800'>
              {account.bankCode} {account.accountType} ISA [중개형]
            </div>
      ...
      <div className='mt-4 bg-primary-2 rounded-xl px-4 py-5 flex justify-between items-center'>
        <div className='text-sm'>
          <p className='text-hana-green font-semibold pb-0.5'>잘하고 있어요!</p>
          <p className='text-subtitle text-xs'>ISA 계좌 활용으로 지금까지</p>
        </div>
